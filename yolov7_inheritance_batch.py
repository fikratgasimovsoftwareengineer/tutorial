...
class Yolov7Processor(Yolov7DNNInference):
   ...
   # INIT of  Parameters
    ...
    def save_image_postprocessed(self, images, img_name):
        ...
        save_dir = os.path.join('/tensorfl_vision/tutorial/static/uploads', base_img_name)
...
def main():
    ...
    image_path = '/tensorfl_vision/tutorial/static/uploads/cat.png'
    ...
    processor = Yolov7Processor(0.3, 0.38, path_to_classes, image_path, path_to_cfg_yolov7, path_to_weights_yolov7,single_image=True)
    
    getImagesInference = processor.inference_image_run(image_path)
